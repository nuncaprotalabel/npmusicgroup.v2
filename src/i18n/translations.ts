...
export const translations = {
  es: {
    ...
    apply: {
      title: "Aplicar a NP Music Group",
      subtitle: "Comparte tu información y el equipo revisará tu solicitud.",
      fields: {
        artisticName: "Nombre artístico",
        artisticNamePlaceholder: "Tu nombre o alias artístico",
        ...
        mainLinkPlaceholder: "https://open.spotify.com/artist/...",
        mainLinkHint: "Spotify, YouTube, SoundCloud, etc.",
        instagram: "Instagram",
        instagramPlaceholder: "@tunombre",
        tiktok: "TikTok",
        tiktokPlaceholder: "@tunombre",
        message: "Mensaje de presentación",
        messagePlaceholder: "Cuéntanos sobre ti, tu trayectoria y qué esperas de NP Music Group…",
        messageHint: "Máximo 1000 caracteres.",
      ...
      errors: {
        ...
        messageTooLong: "El mensaje no puede superar los 1000 caracteres.",
        duplicate: "Ya existe una solicitud pendiente con este correo. Nos pondremos en contacto pronto.",
        server: "Ocurrió un error al enviar tu solicitud. Intenta nuevamente.",
      },
      success: {
        title: "Solicitud recibida",
        message: "Tu solicitud ha sido recibida y será revisada por el equipo de NP Music Group. Nos pondremos en contacto contigo a la brevedad.",
  ...
  en: {
    ...
    apply: {
      title: "Apply to NP Music Group",
      subtitle: "Share your information and the team will review your application.",
      fields: {
        artisticName: "Artist name",
        artisticNamePlaceholder: "Your artist name or alias",
        email: "Email address",
        ...
        tiktok: "TikTok",
        tiktokPlaceholder: "@yourname",
        message: "Introduction message",
        messagePlaceholder: "Tell us about yourself, your career, and what you expect from NP Music Group…",
        messageHint: "Maximum 1000 characters.",
      ...
      errors: {
        ...
        duplicate: "There is already a pending application with this email. We will be in touch soon.",
        server: "An error occurred while submitting your application. Please try again.",
      },
      success: {
        title: "Application received",
        message: "Your application has been received and will be reviewed by the NP Music Group team. We will contact you shortly.",
