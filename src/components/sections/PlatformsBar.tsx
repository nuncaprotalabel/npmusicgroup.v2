...
const platforms = [
  { name: "Spotify", style: "text-white" },
  { name: "Apple Music", style: "text-white" },
  { name: "YouTube", style: "text-white" },
  { name: "TikTok", style: "text-white" },
  { name: "amazon music", style: "text-white" },
  { name: "TIDAL", style: "text-white" },
];
...
export function PlatformsBar({
  label = "Confiando por artistas y sellos independientes en todo el mundo",
  className,
}: PlatformsBarProps) {
  return (
    <div className={cn("border-y border-[#1A1A1A] bg-[#050505] py-10", className)}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <p className="section-label text-center mb-8">{label}</p>
        <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-10 lg:gap-14">
          ...
          <div className="flex items-center gap-1.5 opacity-50 hover:opacity-80 transition-opacity duration-200">
            <svg width="22" height="16" viewBox="0 0 24 17" fill="#FF0000">
          ...
          {/* TikTok */}
          <div className="flex items-center gap-2 opacity-50 hover:opacity-80 transition-opacity duration-200">
            <svg width="16" height="18" viewBox="0 0 24 27" fill="white">
          ...
          {/* Amazon Music */}
          <div className="flex items-center gap-1.5 opacity-50 hover:opacity-80 transition-opacity duration-200">
            <svg width="20" height="14" viewBox="0 0 24 16" fill="white">
          ...
          {/* Tidal */}
          <div className="flex items-center gap-2 opacity-50 hover:opacity-80 transition-opacity duration-200">
            <svg width="20" height="14" viewBox="0 0 30 20" fill="white">
          ...
          <span className="text-sm text-[#404040] font-medium">y más.</span>
        </div>
      </div>
    </div>
  );
