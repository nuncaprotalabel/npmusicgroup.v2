  ...
  return (
    ...
    >
      <div ref={ref} className="w-full max-w-7xl mx-auto px-4 sm:px-6">
        <p className={`section-label text-center mb-7 reveal${inView ? " in-view" : ""}`}>
          {displayLabel}
        </p>
        <div className="flex flex-wrap items-center justify-center gap-5 sm:gap-8 lg:gap-12">
          {/* Spotify */}
          <div className={`flex items-center gap-2 opacity-35 hover:opacity-70 transition-all duration-250 cursor-default reveal${inView ? " in-view" : ""} reveal-delay-1`}>
          ...
          {/* Apple Music */}
          <div className={`flex items-center gap-2 opacity-35 hover:opacity-70 transition-all duration-250 cursor-default reveal${inView ? " in-view" : ""} reveal-delay-2`}>
          ...
          {/* YouTube */}
          <div className={`flex items-center gap-1.5 opacity-35 hover:opacity-70 transition-all duration-250 cursor-default reveal${inView ? " in-view" : ""} reveal-delay-3`}>
          ...
          {/* TikTok */}
          <div className={`flex items-center gap-2 opacity-35 hover:opacity-70 transition-all duration-250 cursor-default reveal${inView ? " in-view" : ""} reveal-delay-4`}>
          ...
          {/* Amazon Music */}
          <div className={`flex items-center gap-1.5 opacity-35 hover:opacity-70 transition-all duration-250 cursor-default reveal${inView ? " in-view" : ""} reveal-delay-5`}>
          ...
          {/* Tidal */}
          <div className={`flex items-center gap-2 opacity-35 hover:opacity-70 transition-all duration-250 cursor-default reveal${inView ? " in-view" : ""} reveal-delay-6`}>
          ...
          <span className={`text-sm text-[#333] font-medium reveal${inView ? " in-view" : ""} reveal-delay-6`}>
            {t.platforms.andMore}
          </span>
        </div>
      </div>
