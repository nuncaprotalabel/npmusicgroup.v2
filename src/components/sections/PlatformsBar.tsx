...
export function PlatformsBar({ label, className }: PlatformsBarProps) {
  ...
  return (
    <div className={cn("border-y border-[#1A1A1A] bg-[#050505] py-8 sm:py-10 w-full overflow-hidden", className)}>
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6">
        <p className="section-label text-center mb-7">{displayLabel}</p>
