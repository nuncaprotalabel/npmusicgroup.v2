              ...
              return (
                ...
                >
                  ...
                  <div className="relative mb-6">
                    <div
                      className="absolute -top-2 -right-2 lg:left-8 lg:right-auto z-10 w-5 h-5 flex items-center justify-center rounded-full bg-[#F5C518] text-black text-[10px] font-bold"
                      aria-hidden="true"
                    >
                      {i + 1}
                    </div>
